...
const I18N = {
  en: {
    ...
    userNotConnectedWarning: "Please connect your Telegram Account or select another sender.",
    userbots: "Userbots",
  ...
  uz: {
    ...
    supportBtn: "💬 @xusanboyman200",
    somethingWentWrong: "Nimadir xato ketdi! Admin: @xusanboyman200",
    adminPanel: "Admin Panel",
    pricingSettings: "Narxlar (⭐ Stars)",
    botPriceLabel: "Bot Stars Narxi",
    userbotPriceLabel: "Userbot Stars Narxi",
    myAccountPriceLabel: "Hisobim Stars Narxi",
    savePricingBtn: "Saqlash",
    payBtn: "To'lash",
    buyDirectBtn: "Sotib olish (@xusanboyman200)",
    recipientInputPlaceholder: "Username yoki ID",
    giftMsgPlaceholder: "Xabar...",
    userNotConnectedWarning: "Telegram hisobingizni ulang yoki boshqa yuboruvchini tanlang.",
    userbots: "Userbotlar",
  ...
  ru: {
    ...
    supportBtn: "💬 @xusanboyman200",
    somethingWentWrong: "Ошибка! Свяжитесь с поддержкой: @xusanboyman200",
    adminPanel: "Панель администратора",
    pricingSettings: "Настройка цен (⭐ Stars)",
    botPriceLabel: "Цена Бот (Stars)",
    userbotPriceLabel: "Цена Юзербот (Stars)",
    myAccountPriceLabel: "Цена Мой аккаунт (Stars)",
    ...
    userNotConnectedWarning: "Подключите аккаунт Telegram или выберите другого отправителя.",
    userbots: "Юзерботы",
